  ...
  const handleAdvanceSearch = async (e) => {
    try {
      ...
      const searchResults = await axios.get(
        `http://localhost:5000/pets/advanceSearch/${typeAdvance}/${adoptionStatus}/${minHeight}/${maxHeight}/${minWeight}/${maxWeight}?name=${petName}`,
        { headers: headers }
      );
      setSearchedPetArray(searchResults.data);
      setDisplayAllPets(false);
  ...
  return (
    <div>
      <div className={styles.searchWrapper}>
        ...
        {basicSearch ? (
          <button className={styles.button} onClick={searchSwitch}>
            Advanced
          </button>
        ) : (
          <button className={styles.button} onClick={searchSwitch}>
        ...
        <button className={styles.button} onClick={showAllPets}>
          Show All Pets
        </button>
            ...
            <div className={styles.inputWrapper}>
              <div className={styles.halfOfInputs}>
                ...
                <select className={styles.input} required value={adoptionStatus} onChange={handleAdoptionStatus}>
                  <option defaultValue={true} value="available">
                    Available
                  </option>
